...
export const SearchAutocomplete: React.FC<SearchAutocompleteProps> = ({ options = [], show = false, onSelect }) => {
    ...
    return (
        <div style={{ transform: 'translateY(63%)', zIndex: 5000, minWidth: 100 }} className="absolute padding-top-s padding-bottom-s box-shadow-small background-bars flex-column border-radius">
